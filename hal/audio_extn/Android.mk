...
LOCAL_C_INCLUDES := \
    ...
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal \
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := $(TOP)/hardware/qcom-caf/sm8150/audio/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal \
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal/audio_extn \
    $(TOP)/hardware/qcom-caf/sm8150/audio/hal/$(AUDIO_PLATFORM) \
